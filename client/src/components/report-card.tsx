...
import ImageModal from "@/components/ImageModal"; // 👈 import your modal
    ...
    >
      ...
      <CardContent className="p-6">
        ...
        <h4
          ...
          data-testid={`location-${report.id}`}
        >
          {report.location}
        </h4>
        {report.description && (
        ...
        <div
          ...
          data-testid={`reporter-${report.id}`}
        >
